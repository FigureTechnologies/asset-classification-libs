...
import com.figure.classification.asset.client.domain.query.QueryAssetDefinition
import com.figure.classification.asset.client.domain.query.QueryAssetDefinitions
import com.figure.classification.asset.client.domain.query.QueryAssetScopeAttribute
import com.figure.classification.asset.client.domain.query.QueryState
import com.figure.classification.asset.client.domain.query.QueryVersion
...
/**
 * The default override of an [ACQuerier].  Provides all the standard functionality to use an [ACClient][com.figure.classification.asset.client.client.base.ACClient] if an override for
