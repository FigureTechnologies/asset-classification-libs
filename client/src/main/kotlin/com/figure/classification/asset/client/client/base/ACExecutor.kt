package com.figure.classification.asset.client.client.base

import com.figure.classification.asset.client.domain.execute.AddAssetDefinitionExecute
import com.figure.classification.asset.client.domain.execute.AddAssetVerifierExecute
import com.figure.classification.asset.client.domain.execute.DeleteAssetDefinitionExecute
import com.figure.classification.asset.client.domain.execute.OnboardAssetExecute
import com.figure.classification.asset.client.domain.execute.ToggleAssetDefinitionExecute
import com.figure.classification.asset.client.domain.execute.UpdateAccessRoutesExecute
import com.figure.classification.asset.client.domain.execute.UpdateAssetDefinitionExecute
import com.figure.classification.asset.client.domain.execute.UpdateAssetVerifierExecute
...
interface ACExecutor {
     ...
     *
     * @param execute The [OnboardAssetExecute] payload that will be sent to the smart contract.
     * @param signer Any implementation of [Signer] to sign the message programmatically.  See [AccountSigner][com.figure.classification.asset.util.wallet.AccountSigner] for a provided implementation.
     ...
     *
     * ADMIN ONLY! Use: [queryContractState][com.figure.classification.asset.client.client.base.ACQuerier.queryContractState] to find the admin address.
     *
     ...
     * bundled with other messages in a transaction.
     *
     * This route will only succeed if the admin address or address in [ownerAddress][com.figure.classification.asset.client.domain.execute.UpdateAccessRoutesBody.ownerAddress] is used.
     *
    ...
    /**
     * Executes the Asset Classification smart contract to update an existing set of [AccessRoutes][com.figure.classification.asset.client.domain.model.AccessRoute] for an owner of an
     * [AccessDefinition][com.figure.classification.asset.client.domain.model.AccessDefinition] on an [AssetScopeAttribute][com.figure.classification.asset.client.domain.model.AssetScopeAttribute].
     * This function will completely replace all existing [AccessRoutes][com.figure.classification.asset.client.domain.model.AccessRoute] for the target owner with the provided values.
     *
     * This route will only succeed if the admin address or address in [ownerAddress][com.figure.classification.asset.client.domain.execute.UpdateAccessRoutesBody.ownerAddress] is used.
     *
     * @param execute The [UpdateAccessRoutesExecute] payload that will be sent to the smart contract.
    ...
    /**
     * Executes the Asset Classification smart contract to delete an [AssetDefinition][com.figure.classification.asset.client.domain.model.AssetDefinition]
