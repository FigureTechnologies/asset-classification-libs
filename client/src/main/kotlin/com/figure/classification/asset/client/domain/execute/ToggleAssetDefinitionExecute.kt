 ...
 * @param expectedResult The state of [AssetDefinition.enabled][com.figure.classification.asset.client.domain.model.AssetDefinition.enabled] after execution completes.  Exists as a latch to ensure
